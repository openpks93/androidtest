...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goVending = (Button)findViewById(R.id.govending);
        goVending.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent goVend = new Intent(MainActivity.this, VendingActivity.class);
                MainActivity.this.startActivity(goVend);
            }
        });
