...
public class VusicView extends  View{
    ...
    public VusicView(Context context) {
        this(context, null);
    }

    public VusicView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VusicView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context, attrs, defStyleAttr);
        initRandom();
    }
    public VusicView setImages(int[] imageArray){
    ...
    private class Notes {
        ...
        private void init() {
             ...
             */
            if(myImageList==null){
                myImageList = new int[]{R.drawable.note1, R.drawable.note2, R.drawable.note3, R.drawable.note4, R.drawable.note5};
                images = new Drawable[myImageList.length];
